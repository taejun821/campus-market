...
# 서버 백그라운드 실행
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$PSScriptRoot'; `$env:JAVA_HOME='C:\Users\user\.jdks\ms-17.0.18'; `$env:PATH=`"`$env:JAVA_HOME\bin;`$env:PATH`"; .\gradlew.bat bootRun"
